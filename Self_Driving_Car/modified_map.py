...
class MyPaintWidget(Widget):
    def on_touch_down(self, touch):
        ...
        with self.canvas:
            ...
            n_points = 0
            length = 0
            if int(touch.y) <= 1061: #added this to prevent crashing when sand is very close to the border
    ...
    def on_touch_move(self, touch):
        ...
        if touch.button == 'left':
            ...
            touch.ud['line'].width = int(10 * density + 1)
...
class CarApp(App):
    def build(self):
        ...
        clearbtn = Button(text = 'Clear Map', opacity=0.5)
        maploadbtn = Button(text = 'Load Map', pos = (parent.width, 0), opacity=0.5)
        mapsavebtn = Button(text = 'Save Map', pos = (2 * parent.width, 0), opacity=0.5)
        loadbtn = Button(text = 'Load Brain', pos = (3 * parent.width, 0), opacity=0.5)
        savebtn = Button(text = 'Save Brain', pos = (4 * parent.width, 0), opacity=0.5)
        brainbtn = Button(text = 'Brain Graph', pos = (5 * parent.width, 0), opacity=0.5)
